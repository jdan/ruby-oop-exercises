...
RSpec.describe Chapter01::Rectangle do
  describe '#initialize' do
    it 'creates a rectangle with width and height' do
      rect = described_class.new(10, 5)
  ...
  describe '#area' do
    ...
    it 'works with different dimensions' do
      rect = described_class.new(7, 3)
      expect(rect.area).to eq(21)
    end

    it 'handles square dimensions' do
      rect = described_class.new(4, 4)
