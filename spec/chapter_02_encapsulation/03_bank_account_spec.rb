...
RSpec.describe Chapter02::BankAccount do
  ...
  describe '#balance' do
    it 'returns the current balance' do
      account = described_class.new('Alice', 50)
  ...
  describe '#withdraw' do
    it 'removes money from the balance' do
      account = described_class.new('Alice', 100)
      account.withdraw(30)
