...
RSpec.describe Chapter02::Temperature do
  describe '#initialize' do
    it 'creates a temperature with Celsius value' do
      temp = described_class.new(25)
      expect(temp).to be_a(described_class)
    end
  end
  ...
  describe '#kelvin' do
    ...
    it 'converts -273.15 Celsius to 0 Kelvin (absolute zero)' do
      temp = described_class.new(-273.15)
